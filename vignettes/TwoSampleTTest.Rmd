...
vignette: >
  %\VignetteIndexEntry{Two-sample t-test power analysis}
...
The paired design should more efficient here: it typically reaches target power
with fewer after samples because it eliminates between-site baseline
variability as a source of error. Still working on why it isn't.
