---
title: "PowerAfterChange: Simulation Tests for Alternative Distributions and Tests"
author: "Beth Babcock"
date: "`r Sys.Date()`"
...
This vignette simulates data and tests the updated functions across supported distributions (`normal`, `nbinom`, `binomial`) and test options (`paired-t`, `wilcoxon`, `prop.test`).
